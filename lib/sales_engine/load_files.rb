...
# merchant = Merchant.find_by_id(29)
# puts merchant.created_at.class

# puts merchant = Merchant.find_by_name("Kirlin, Jakubowski and Smitham")
# puts
# puts merchant.items.count
# puts
# puts merchant.items.find {|i| i.name == 'Item Consequatur Odit' }
# puts
# puts merchant.invoices.count
# puts
# puts merchant.invoices.find {|i| i.customer.last_name == 'Block' }.status
# puts
# puts
# puts
